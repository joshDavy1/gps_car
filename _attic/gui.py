...
class MainWindow():
    def __init__(self, root):
        ...
        self.gbutton = Button(self.root, text="Call", bg="white", height=10, width=20)
        self.gbutton.place(relx = 0.1, rely = 0.5, anchor = 'w') 
        self.gbutton.config(highlightbackground="green")

        self.rbutton = Button(self.root, text="Cancel", bg="white", height=10, width=20)
        self.rbutton.place(relx = 0.5, rely = 0.5, anchor = CENTER) 
        self.rbutton.config(highlightbackground="red")

        self.bbutton = Button(self.root, text="Load", bg="white", height=10, width=20)
